...
Last Docker Desktop supporting MacOS Catalina is version 4.15.0

It can be downloaded from


```https://desktop.docker.com/mac/main/amd64/93002/Docker.dmg?_gl=1*1ajkt*_ga*MTI4MjkwNjY3OS4xNjkwMzg4MTM5*_ga_XJWPQMJYHQ*MTY5MDM4ODEzOS4xLjEuMTY5MDM4ODIzNi40Ni4wLjA.```